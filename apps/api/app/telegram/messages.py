...
def cart_reminder(title: str, deadline_at: datetime) -> str:
    ...
    return (
        f"Напоминание: товары в вашей корзине Sulu by Lulu по сбору {title} "
...
def cart_last_chance(title: str, deadline_at: datetime) -> str:
    ...
    return (
        ...
        "Товары из корзины Sulu by Lulu удалятся, если до этого времени не оформить заявку."
    )
...
START = (
    "Добро пожаловать в Sulu by Lulu! Поделитесь номером телефона, чтобы привязать "
