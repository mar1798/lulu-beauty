...
const nextConfig = {
  ...
  experimental: {
    /**
     * Позиция прокрутки при «назад» — своя, а не браузерная. Браузер
     * восстанавливает её до того, как Next дорисует прежнюю страницу, и
     * покупатель, открывший товар с 20-й карточки, возвращался в самый верх
     * каталога.
     */
