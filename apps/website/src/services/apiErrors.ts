...
const MESSAGES: Record<string, string> = {
  ...
  */
  ...
  order_not_restorable:
    'Вернуть заявку нельзя: её отменил магазин, сбор закрылся или в ней не осталось товаров',
...
const SCOPED: Partial<Record<ErrorScope, Record<string, string>>> = {
  ...
  'order.cancel': {
    order_not_editable:
      'Отменить заявку нельзя: сбор закрылся или её взяли в работу. Напишите нам напрямую.',
  },
  'order.restore': {
