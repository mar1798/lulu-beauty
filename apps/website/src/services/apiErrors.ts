...
const MESSAGES: Record<string, string> = {
  ...
  */
  ...
  order_not_restorable:
    'Вернуть заявку нельзя: её отменил владелец, сбор закрылся или в ней не осталось товаров',
  ...
  account_not_deletable:
    'Аккаунт с доступом в админку удалить нельзя. Сначала владелец снимает роль — после этого аккаунт удаляется как обычный.',
  ...
  account_has_unfinished_orders:
    'Сначала нужно закрыть заявки, по которым товар уже куплен: подтверждённые и готовые к выдаче. Заберите товары или попросите владельца изменить их статус — и аккаунт можно будет удалить.',
