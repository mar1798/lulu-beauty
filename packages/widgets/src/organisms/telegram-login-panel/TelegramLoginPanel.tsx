 ...
 * будет здесь, — иначе он вернётся на неизменившийся экран и станет искать
 * поле для кода, которого не существует.
 *
          ...
          */}
          {status === 'waiting' && (
            <Text className={styles.waiting} size="sm" tone="secondary">
              Подтвердите вход в Telegram — эта страница откроется сама. Код вводить не
              нужно.
            </Text>
          )}
