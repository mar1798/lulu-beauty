...
export interface IProductCardProps {
   ...
   *
   * Нужен ровно одной карточке на странице — первой в витрине героя: она
   * попадает в первый экран и оказывается его LCP-элементом. В сетке каталога
   * не используется: там приоритет у всех — это приоритет ни у кого.
   */
  isPriority?: boolean
}
